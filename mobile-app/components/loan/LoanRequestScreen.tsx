...
export function LoanRequestScreen({visible, onClose, onLoanCreated}: Props) {
  ...
  const requestLoan = async () => {
    ...
    try {
      ...
      console.log('LoanRequestScreen: Sending transaction with amount:', amount, 'MXN, days:', days);
      ...
      if (e.message.includes('insufficient funds')) {
        setData('Insufficient funds. Please make sure you have enough MXN for gas fees.');
